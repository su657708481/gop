...
{
  // 上下文对象化 by WUWENBIN
               boolean isObject = !decl().type().isPrimitive() && !decl().type().typeName().equals("java.lang.String");

			   String methodname = new String(isObject ? "getContextObject" : "getContext");
			...
			l.add(para3);	
		       ...
		       if (decl().type().isPrimitive()) {
		           ...
		           return new CastExpr(decl().type().createQualifiedAccess(), d);
               }
