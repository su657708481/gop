  ...
  public boolean hasSuperShadowClass()
{
  ...
  public void generateClassfile() {
        ...
        try {
            ...
            attributes();
            System.out.println(cp.numElements());
...
////================================================
  ...
  public void setCompositeName(String id) {
      compositeName = id;
  }
  private String name_compute() {  return compositeName == null ? ((TypeAccess)getGranuleAccess()).name()+"_"+getID() : compositeName;  }
...
{   
  ...
  public TypeDecl Define_TypeDecl_hostType(ASTNode caller, ASTNode child) {
    ...
    if (caller instanceof ConstructorDecl) {
        return hostType();
    }
